        ...
        <div class="bg-gray-100 dark:bg-gray-800 flex rounded shadow-lg max-w-3xl p-5 items-center" data-aos="fade" data-aos-duration="700">
            ...
            <div class="md:w-1/2 px-10">
                ...
                <form method="POST" action="{{ route('register') }}" class="flex flex-col gap-4">
                    ...
                    <div class="relative">
                        <input class="p-2 rounded border border-gray-300 bg-white w-full" type="password" name="password_confirmation" placeholder="Konfirmasi Password" required>
                    ...
                    <button class="bg-[#002074] dark:bg-blue-800 rounded text-white py-2 hover:scale-105 duration-300 cursor-pointer" type="submit">Register</button>
                </form>
